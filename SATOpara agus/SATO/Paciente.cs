...
namespace Presentacion
{
    public partial class frmPaciente : Form
    {
        ...
        {
            Negocio.LogicaNegocio negocio = new Negocio.LogicaNegocio();
            List<CoberturaMedica> coberturasMedicas= negocio.obtenerCoberturasMedicas();
        ...
        private void mostrarCuentasUsuario()
        {
            ...
            cmbCuenta.DataSource = negocio.obtenerCuentasPaciente();
        }
        ...
        private Boolean guardarPaciente()
        {
            ...
            if(logicaNegocio.tomarPaciente(paciente))
            {
                return true;
            }
            else
        ...
        private void btnBuscarDepartamento_Click(object sender, EventArgs e)
        {
            ...
            vtDepartamento.mostrarProvincia(provincia);
        ...
        private void btnFiltrarCobertura_Click(object sender, EventArgs e)
        {
            ...
            {
                LogicaNegocio negocio = new LogicaNegocio();
                List<CoberturaMedica> lstCoberturas = negocio.obtenerCoberturasPorBusqueda(parametro);
        ...
        private void eliminarPaciente(String numeroPaciente)
        {
            ...
            if (logica.tomarPacienteAEliminar(paciente))
        ...
        private Boolean modificarPaciente()
        {
            ...
            LogicaNegocio logicaNegocio = new LogicaNegocio();
            string mensaje = logicaNegocio.tomarModificacionPaciente(paciente, numeroPacViejo, tipoDniViejo, nroDniViejo);
