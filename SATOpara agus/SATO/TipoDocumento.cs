...
namespace Presentacion
{
    public partial class frmTiposDocumento : Form
    {
        ...
        private Boolean guardarTipoDocumento()
        {
            ...
            TipoDocumento td = new TipoDocumento(nombreTipoDoc, siglaTipoDoc, comentarioTipoDoc);

            LogicaNegocio logicaNegocio = new LogicaNegocio();
            if (logicaNegocio.tomarTipoDocumento(td)) 
            {
                return true;
            }
            else
        ...
        private Boolean modificarTipoDocumento()
        {
            ...
            LogicaNegocio logicaNegocio = new LogicaNegocio();
            string mensaje = logicaNegocio.tomarModificacionTipoDocumento(td, nombreViejo);
        ...
        private void dgvTiposDocumento_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.ColumnIndex >= 0)
            {
                ...
                tipoDoc = negocio.obtenerTipoDocumentoPorId(tipoDoc.IdTipoDocumento);
        ...
        private void eliminarTipoDocumento(String nombreTipoDoc)
        {
            ...
            if (logica.tomarTipoDocumentoAEliminar(tipoDocumento))
            {
