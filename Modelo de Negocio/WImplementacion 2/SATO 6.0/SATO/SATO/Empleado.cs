...
namespace Presentacion
{
    public partial class frmEmpleado : Form
    {
        ...
        {
            frmProvincia eProvincia = new frmProvincia();
            eProvincia.ShowDialog();
        }

        private void button13_Click(object sender, EventArgs e)
        {
            frmDepartamento eDepartamento = new frmDepartamento();
            Provincia provincia = (Provincia)cmbProvinciaEmpleado.SelectedItem;
            eDepartamento.mostrarProvincia(provincia);
            eDepartamento.ShowDialog();
        }

        private void button14_Click(object sender, EventArgs e)
        {
            frmLocalidad eLocalidad = new frmLocalidad();
            Provincia provincia = (Provincia)cmbProvinciaEmpleado.SelectedItem;
            Departamento departamento = (Departamento)cmbDepartamentoEmpleado.SelectedItem;
            eLocalidad.mostrarProvinciaYDepartamento(provincia, departamento);
            eLocalidad.ShowDialog();
        }
        ...
        private void mostrarProvincias()
        {
            ...
            cmbProvinciaEmpleado.DataSource = negocio.obtenerProvincias();
        }
        ...
        private void mostrarDepartamentosPorProvincia(int idProvincia)
        {
            ...
            cmbDepartamentoEmpleado.DataSource = negocio.obtenerDepartamentosPorProvincia(idProvincia);
        }
        private void mostrarLocalidadesPorDepartamento(int idDepartamento)
        {
            ...
            cmbLocalidadEmpleado.DataSource = negocio.obtenerLocalidadesPorDepartamento(idDepartamento);
        }
        private void mostrarBarriosPorLocalidad(int idLocalidad)
        {
            ...
            cmbBarrioEmpleado.DataSource = negocio.obtenerBarriosPorLocalidad(idLocalidad);
        }
        private void mostrarTiposTelefono()
        {
            ...
            cmbTipoTelefonoEmpleado.DataSource = negocio.obtenerTiposTelefono();
        }
        private void mostrarTiposDocumento()
        {
            ...
            cmbTipoDocumentoEmpleado.DataSource = negocio.obtenerTiposDocumento();
        }
        ...
        private void mostrarSexos()
        {
            ...
            cmbSexoEmpleado.DataSource = negocio.obtenerSexos();
        }
        private void mostrarCuentasUsuario()
        {
            ...
            cmbCuentaEmpleado.DataSource = negocio.obtenerCuentas();
        }
        private void mostrarEstadosUsuario()
        {
            ...
            cmbEstadoEmpleado.DataSource = negocio.obtenerEstadosUsuarios();
        }
        private Boolean guardarEmpleado()
        {
            ...
            if (logicaNegocio.tomarEmpleado(e)) 
            {
                return true;
            }
            else
        ...
        private void btnBuscarEmpleado_Click(object sender, EventArgs e)
        {
            ...
            LogicaNegocio logicaNegocio = new LogicaNegocio();
            List<Empleado> lsEmpleados = logicaNegocio.obtenerEmpleadosPorBusqueda(parametro);
        ...
        {
            LogicaNegocio negocio= new LogicaNegocio();
            Empleado empleado= negocio.obtenerEmpleadoPorLegajo(leg);
        ...
        private Boolean modificarEmpleado()
        {
            ...
            LogicaNegocio logicaNegocio = new LogicaNegocio();
            string mensaje = logicaNegocio.tomarModificacionEmpleado(e, legajoViejo, tipoDniViejo, nroDniViejo);
        ...
        private void eliminarEmpleado(String legajoEmp)
        {
            ...
            if (logica.tomarEmpleadoAEliminar(empleado))
            {
